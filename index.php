...
<html>
<head>
<title>Launch Page: Labyrinth Lord Fighter Generator</title>
...
<body>
	...
	<section>
		...
		<form action="" id ="fighterForm"  target="_blank" method="post">
            ...
            <span class="formIputDescription">Character Level:</span>	
			  <select id="level" name="theLevel" class="alignmentBox">	
				<option value="1" selected>1st Level, Fighter</option>
				<option value="2">2nd Level, Fighter</option>
				<option value="3">3rd Level, Fighter</option>
				<option value="4">4th Level, Fighter</option>
				<option value="5">5th Level, Fighter</option>
				<option value="6">6th Level, Fighter</option>
				<option value="7">7th Level, Fighter</option>
				<option value="8">8th Level, Fighter</option>
				<option value="9">9th Level, Fighter</option>
				<option value="10">10th Level, Fighter</option>
				<option value="11">11th Level, Fighter</option>
				<option value="12">12th Level, Fighter</option>
				<option value="13">13th Level, Fighter</option>
				<option value="14">14th Level, Fighter</option>
				<option value="15">15th Level, Fighter</option>
			  </select>
            ...
            <br/>
			  ...
			  <select id="hitDice" name="theHitDice" class="alignmentBox">	
				<option value="1" selected>d8, standard HD</option>
				<option value="2">d10, advanced HD (optional)</option>
			  </select>
			...
			<div class="generatorButtonA2">
                ...
                <script>
                    ...
                    $("#generate_characters2").click(function(){
                        ...
                        $("#fighterForm").attr('action', "character/ll_fighter_"+ $("#abilityScores").val() +  ".php");
